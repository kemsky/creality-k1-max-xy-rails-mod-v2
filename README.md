# Creality `K1 Max` XY Rails Mod V2
...
You'll need 1 M3x35 screw from stock gantry motor mounts and 1 M3 5x7 mm heat insert, alternatively you can use M4x35 SHCS screw.
...
<details>
    <summary>Preview</summary>
    <img title="k1_cutter_block.stl" alt="k1_cutter_block.stl" src="images/assembly/k1_cutter_block_orthographic_axo.png">
</details>
<br>
